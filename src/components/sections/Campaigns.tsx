...
const Campaigns: React.FC = () => {
  ...
  return (
    <div className="p-8">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="text-center max-w-4xl">
              <h1 className="text-5xl font-extralight mb-6 tracking-tight">
                ...
                <span className="block text-gray-300">One voice, everywhere.</span>
              </h1>
      ...
      {/* Features Grid */}
      <section className="mb-16">
        <h2 className="text-3xl font-light mb-8 tracking-wide">Core Features</h2>
            ...
            return (
              <div key={index} className="bg-gray-900 p-8 rounded-lg">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-medium">{prompt.title}</h3>
                  <span className={`px-2 py-1 text-xs rounded ${
                    prompt.type === 'copy' ? 'bg-blue-900 text-blue-200' : 'bg-purple-900 text-purple-200'
                  }`}>
                    {prompt.type}
                  </span>
                </div>
                <p className="text-gray-300 italic leading-relaxed">"{prompt.prompt}"</p>
              </div>
            );
          })}
        </div>
      ...
      {/* Visual/UX Notes */}
      <section>
        <h2 className="text-3xl font-light mb-8 tracking-wide">Visual & UX Design</h2>
        <div className="bg-gray-900 p-8 rounded-lg">
          <div className="grid lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-medium mb-4">Design Elements</h3>
            ...
            <div>
              <h3 className="text-xl font-medium mb-4">Interaction Patterns</h3>
              <ul className="text-gray-300 space-y-2">
